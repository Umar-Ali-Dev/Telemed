...
export const ADMIN_DASHBOARD_DATA = [
  ...
  },
  {
    id: 18,
    name: "Nancy Cooper",
    email: "n.cooper@yahoo.com",
    phone: "(415) 555 0177",
    provider: "----",
    status: "Waiting provider",
    updatedAt: "02/22/2026",
  },
  {
    id: 19,
    name: "Steven Baker",
    email: "s.baker@gmail.com",
    phone: "(617) 555 0166",
    provider: "----",
    status: "Waiting provider",
    updatedAt: "02/22/2026",
...
export const ADMIN_PROVIDER_REQUEST_DATA = [
  {
    id: 1,
    name: "Jospan Franklin",
    email: "jospan@gmail.com",
